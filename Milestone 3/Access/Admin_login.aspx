<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_login.aspx.cs" Inherits="Milestone_3.Login.Admin_login" %>
...
<head runat="server">
    <title>Admin</title>
    <link rel="icon" href="../Home/Icons/Admin.png" type="image/x-icon"/>
